export const checkboxType = {
    ...
    zsk_geographical_temp: [
        {field: "geographicalName", title: "地名专名", isActive: false},
        {field: "sourceName", title: "知识出处", isActive: false},
        {field: "azimuth", title: "参考方位", isActive: false},
        {field: "administrativeLevel", title: "行政层级", isActive: false}
    ],
    zsk_product_temp: [
        {field: "productName", title: "物产名称", isActive: false},
        {field: "sourceName", title: "知识出处", isActive: false},
        {field: "originPlace", title: "产地", isActive: false},
        {field: "yield", title: "产量", isActive: false},
        {field: "type", title: "物产类型", isActive: false},
        {field: "description", title: "物产描述", isActive: false}
    ]
}
